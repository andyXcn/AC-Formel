**Meine Überlegungen:**\
Ansatz und vereinfachte Formel zur Bestimmung eines Integrals einer e-Funktion multipliziert mit einem beliebigen Polynom, eine exponentiell-polynomielle Funktion.\
Alternative Variante zum Formansatz und zur partitiellen Integration.\
\
An einer Formalisierung wird aktuell gearbeitet :-)
\
\
_Drei (oder mehr) Rechtschreibfehler sind drin, jedoch in der Version noch nicht verbessert_
\
\
**UPDATE**\
